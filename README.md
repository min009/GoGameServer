...
What is Go Game: the game is played by two players who alternatively place black and white stones.  The object of the game is to use one’s stones to surround a larger portion of the board than the opponent. Let’s say a block of stones are surrounds by white stones, then these block of stones are captured. The white player get points.
