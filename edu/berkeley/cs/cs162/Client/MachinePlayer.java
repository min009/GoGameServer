...
public class MachinePlayer extends Player {
	...
	public ClientInfo getClientInfo() {
    	...
    	blah.playerType = MessageProtocol.TYPE_MACHINE;
    	return blah;
    }
    ...
    public static void main(String[] args) {
    	...
    	try{ 
            ...
            Integer p = rand2.nextInt();
            password = p.toString();
    		while(true){
	    		MachinePlayer player_obj = new MachinePlayer();
	        	...
	        	int id = 0;
	        	MachinePlayerWorker w1 = new MachinePlayerWorker(IPInfo, port, randNum, twh_semaphore1, magical_semaphore, player_obj,id,password, recover);
	        	id += 1;
	    		MachinePlayerWorker w2 = new MachinePlayerWorker(IPInfo, port, randNum, twh_semaphore2, magical_semaphore, player_obj,id,password, recover);
